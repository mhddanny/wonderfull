        ...
        <table cellpadding="0" cellspacing="0">
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                {{ auth()->guard('customer')->user()->nohp }}<br>
                                {{ auth()->guard('customer')->user()->alamat }}<br>
                            ...
                            <td>
                                ...
                                MHD DANNY<br>
                                08572330324<br>
                                Jl Trsansiro gang Suka Jaya V<br>
                                Tanjungpinang Timur<br>
                                Kepulaun Riau
                            </td>
                        </tr>
                    </table>
            ...
            <tr class="item">
                <td>
                    ...
                    <strong>Harga</strong>: @rupiah($row->price) x {{ $row->qty }}
                </td>
                <td>@rupiah($row->price * $row->qty) </td>
            </tr>
            @endforeach
            ...
            <tr class="total">
                <td></td>
                <td>
                   Pembayaran:  -@rupiah($order->payment->amount)
                </td>
            </tr>
            <tr>
