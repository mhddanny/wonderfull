      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <div class="right">
            ...
            @else
              <a class="btn btn-sm btn-outline-success" href="{{ route('produk.create') }}"><span class="glyphicon glyphicon-plus"></span>Create</a>
            @endif
              <a class="btn btn-sm btn-outline-primary" href="{{ route('produk.bulk') }}"><span class=""></span>Upload Data</a>
          </div>
        </div>
        <div class="col-sm-6">
