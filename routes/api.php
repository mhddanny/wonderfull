...
Route::get('city', 'Web\CartController@getCity'); //ROUTE API UNTUK /CITY
Route::get('district', 'Web\CartController@getDistrict'); //ROUTE API UNTUK /DISTRICT

Route::post('cost', 'Web\CartController@getCourier');//Route Api Ongkir
