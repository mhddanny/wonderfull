...
class OrderController extends Controller
{
      public function index()
      {
       ...
       return view('wonderful.orders.index', compact('orders')); //LOAD VIEW INDEX DAN PASSING DATA TERSEBU
      ...
      {
          $order = Order::with(['customer.district.city.province', 'payment', 'details.produk'])->where('invoice', $invoice)->first();
          return view('wonderful.orders.view', compact('order'));
      }
      ...
      public function return($invoice)
      {
          ...
          return view('wonderful.orders.return', compact('order'));
      }
