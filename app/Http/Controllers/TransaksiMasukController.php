...
class TransaksiMasukController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('wonderful.transaksi_masuk.index',compact('transaksi_masuk','start_date','end_date'));
    }
    ...
    public function create()
    {
        ...
        return view('wonderful.transaksi_masuk.create',compact('produk','supplier'));
    }
